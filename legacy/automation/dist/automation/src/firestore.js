...
export async function findStuckProcessing(minutes) {
...
export async function requeueReport(reportId, retries, detail, retryAfter) {
...
export async function findRecentSubmissions(windowHours) {
...
export async function updateReportStatus(reportId, status, detail, portalCaseId) {
    const update = {
        status,
...
export async function saveReportDraft(reportId, draft) {
